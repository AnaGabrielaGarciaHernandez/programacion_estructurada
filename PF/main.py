   ...
   while opcion:
      try:
         ...
         if opcion=="1":
            ...
            guardar=input("\n\t\t ⚠️ Desea exportar los datos a Excel? (si/no): ").lower().strip()
            if guardar=="si":
         ...
         print(f"\n\t\t ⚠️ Ha ocurrido un error inesperado: {e}")
         funciones.esperarTecla()
      ...
      if opcion=="1":
         ...
         if inven=="1":
            try:
               ...
               print("\n\t\t ...⚠️ Ocurrio algo innesperado, vuelve a intentarlo ⚠️...")
            funciones.esperarTecla()
         elif inven=="2":
            try:
               funciones.borrarPantalla()
               ...
               if resp=="si":
                  ...
                  if respuesta:
                     print("\n\t\t ⚠️ Se borró exitosamente")
               if resp=="no":
                  funciones.esperarTecla()
            except:
               print("\n\t\t ...⚠️ Ocurrio algo innesperado, vuelve a intentarlo...")
            funciones.esperarTecla()
         elif inven=="3":
            try:
               funciones.borrarPantalla()
            ...
            try:
               ...
               if modif:
                  ...
                  print("\t \u274C.:: No hay Articulos en el Sistema ::. \u274C")
               pregunta_modificar=input("⚠️ ¿Deseas modificar un articulo del inventario? (Si/No)?: ").lower()
         ...
         if vent=="1":
            try:
               ...
               if nueva_vent:
                  ...
                  print("\t \u274C.:: No hay Articulos en el Sistema ::. \u274C")
               id_agregar = input("\n\t\t \U0001F4DD ID del producto: ").upper().strip()
               unidades_input = input("\n\t\t \U0001F4DD Unidades vendidas: ").strip()
               nueva=venta.agregarVenta(id_usuario,id_agregar,unidades_input)
               if nueva:
                  print("\n\t\t ⚠️ Venta agregada exitosamente...")
            except:
               print("\n\t\t ...⚠️ Ocurrio algo innesperado, vuelve a intentarlo...")
            funciones.esperarTecla()
         elif vent=="2":
            ...
            try:
               ...
               if preg_modificar=="si":
                  ...
                  if modificar_venta:
                     print("\n\t\t ⚠️ La venta se modifico exitosamente...")
            except:
               print("\n\t\t ...⚠️ Ocurrio algo innesperado, vuelve a intentarlo...")
            funciones.esperarTecla()
         elif vent=="4":
